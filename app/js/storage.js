...
var Store = (function () {
  ...
  /* ---- settings ---- */
  var DEFAULTS = { liveFormat: 'm3u8', engine: 'auto', parental: true, autostart: false, theme: 'neon-cyber', tmdbKey: '', preview: true, lang: 'en', refreshHours: 6, layout: 'classic', focusStyle: 'glow', largeUi: false, highContrast: false, liveGrid: false, ambient: true, weather: true, autoNext: true, accent: 'auto', pointer: 'click', corners: 'round', glow: true, wxMode: 'auto', wxUnit: 'c', adhan: true, adhanMethod: 'algeria', pictureMode: 'original', pictureBrightness: 100, pictureContrast: 100, pictureSaturation: 100, pictureTone: 0, pictureBlackLevel: 0, pictureGamma: 0, aspectRatio: 'fit', playerVolume: 70, playerMuted: false, playerOverlayTimeout: 6000 };
  /* Retired theme IDs map once into the new registry. Ramadan and Majlis are
     intentionally not migrated: the user explicitly kept these heritage worlds. */
  var THEME_MIGRATE = { dark: 'neon-cyber', aurora: 'neon-cyber', midnight: 'tactical-dark', oled: 'minimal-white', ocean: 'ocean-deep', crimson: 'crimson-cinema', emerald: 'emerald-nature', sunset: 'solar-orange', royal: 'space-galaxy', cinema: 'crimson-cinema', glass: 'glass-aurora', arcade: 'retro-80s', mono: 'minimal-white', guidepro: 'tactical-dark', receiver: 'tactical-dark', sports: 'solar-orange', family: 'emerald-nature', neocrt: 'retro-80s', cyberpunk: 'neon-cyber' }, LAYOUT_MIGRATE = { viu: 'spotlight', ibo: 'trio' };
